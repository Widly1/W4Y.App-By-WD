                ...
                ZStack(alignment: .topLeading) {
                    ...
                    VStack {
                        ...
                        VStack{
                            ...
                            AsyncImage(url: URL(string: "https://source.unsplash.com/695x390/?marvel")) { image in image
                                    .resizable()
                    ...
                    VStack {
                        ...
                        .background(LinearGradient(
                            ...
                            [isNight ? .gray : Color(hue: 0.583, saturation: 0.839, brightness: 0.967, opacity: 0.813),
                             isNight ? .gray : .black]),
